...
@section('meta')
    <meta name="description" content="{!! htmlspecialchars($singleNews->meta_description) !!}">
    ...
    <meta name="twitter:description" content="{!! htmlspecialchars($singleNews->meta_description) !!}">
